...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/user/Dropbox/projects/nim/stui/devtools/nimcache/stdlib_parseutils.o /home/user/Dropbox/projects/nim/stui/devtools/nimcache/stdlib_parseutils.c */
...
STRING_LITERAL(TM_vI9aZNKIcImom6dDyKXW1ZA_20, "overflow", 8);
...
N_LIB_PRIVATE N_NIMCALL(NI, rawParseInt_ZzngwN3GXlI9aVYNxHLGOXQ)(NimStringDesc* s, NI64* b, NI start) {
	...
	{
		NI64 TM_vI9aZNKIcImom6dDyKXW1ZA_18;
		...
		(*b) = IL64(0);
		{
			...
			while (1) {
				NI64 TM_vI9aZNKIcImom6dDyKXW1ZA_13;
				NI TM_vI9aZNKIcImom6dDyKXW1ZA_14;
				NI64 TM_vI9aZNKIcImom6dDyKXW1ZA_15;
				NI TM_vI9aZNKIcImom6dDyKXW1ZA_16;
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				if (!(((NU8)(s->data[i])) >= ((NU8)(48)) && ((NU8)(s->data[i])) <= ((NU8)(57)))) goto LA13;
				nimln_(241, "parseutils.nim");
				TM_vI9aZNKIcImom6dDyKXW1ZA_13 = mulInt64((*b), IL64(10));
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				TM_vI9aZNKIcImom6dDyKXW1ZA_14 = subInt(((NU8)(s->data[i])), ((NI) 48));
				TM_vI9aZNKIcImom6dDyKXW1ZA_15 = subInt64((NI64)(TM_vI9aZNKIcImom6dDyKXW1ZA_13), ((NI64) ((NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_14))));
				(*b) = (NI64)(TM_vI9aZNKIcImom6dDyKXW1ZA_15);
		...
		TM_vI9aZNKIcImom6dDyKXW1ZA_18 = mulInt64((*b), sign);
		(*b) = (NI64)(TM_vI9aZNKIcImom6dDyKXW1ZA_18);
		nimln_(245, "parseutils.nim");
		TM_vI9aZNKIcImom6dDyKXW1ZA_19 = subInt(i, start);
		result = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_19);
	}
	LA10_: ;
	popFrame();
	return result;
...
N_LIB_PRIVATE N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	nimln_(266, "parseutils.nim");
	{
		...
		T9_ = (NimStringDesc*)0;
		T9_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_vI9aZNKIcImom6dDyKXW1ZA_20));
