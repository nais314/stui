...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/user/Dropbox/projects/nim/stui/devtools/nimcache/stdlib_strutils.o /home/user/Dropbox/projects/nim/stui/devtools/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_4, "0123456789ABCDEF", 16);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_5, "invalid integer: ", 17);
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_14, "invalid format string", 21);
	...
	result = mnewString(((NI) (len)));
	{
		...
		res = colontmp_;
		{
			while (1) {
				...
				j = res;
				result->data[j] = ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_4)->data[(NI64)(n & IL64(15))];
...
appendString(T20_, ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_5));
appendString(T20_, s);
...
N_LIB_PRIVATE N_NIMCALL(NIM_CHAR, nsuToLowerAsciiChar)(NIM_CHAR c) {
	...
	nimln_(207, "strutils.nim");
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_7 = addInt(((NU8)(c)), ((NI) 32));
		result = ((NIM_CHAR) (((NI)chckRange((NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_7), ((NI) 0), ((NI) 255)))));
	}
	goto LA1_;
	LA3_: ;
	{
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuToLowerAsciiStr)(NimStringDesc* s) {
	...
	result = mnewString(((NI)chckRange((s ? s->Sup.len : 0), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
		...
		TM_JGc9b9bh2D3nTdUR7TGyq8aA_6 = subInt((s ? s->Sup.len : 0), ((NI) 1));
		colontmp_ = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_6);
...
{	result = (NI)0;
	...
	m = (((a ? a->Sup.len : 0) <= (b ? b->Sup.len : 0)) ? (a ? a->Sup.len : 0) : (b ? b->Sup.len : 0));
	{
		...
		while (1) {
			...
			TM_JGc9b9bh2D3nTdUR7TGyq8aA_9 = subInt(((NU8)(T3_)), ((NU8)(T4_)));
...
N_LIB_PRIVATE N_NOINLINE(void, invalidFormatString_61EJWW6vRISEo9a8gt0tusw)(void) {
	...
	(*e).Sup.Sup.m_type = (&NTI_Gi06FkNeykJn7mrqRZYrkA_);
	T1_ = (NimStringDesc*)0;
	T1_ = (*e).Sup.message; (*e).Sup.message = copyStringRC1(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_14));
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, alignLeft_i9aDpuCfgBy0NVrlXlv36bA)(NimStringDesc* s, NI count, NIM_CHAR padding) {
	...
	result = (NimStringDesc*)0;
	{
		...
		result = mnewString(count);
		{
			...
			T9_ = dotdot__vDQySKWzgnxQdUarow6k5Qtimes(((NI) 0), (NI)((s ? s->Sup.len : 0) - ((NI) 1)));
			X5BX5Deq__S9coE9cSZKnhx2dOL8sov4fQ((&result), T9_, s);
		}
		LA7_: ;
		{
			NI i;
