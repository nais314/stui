...
/* Command for C compiler:   gcc -c  -w -pthread -g3 -O0 -O3 -fno-strict-aliasing  -I/usr/lib/nim -o /home/user/Dropbox/projects/nim/stui/nimcache/stdlib_epoll.o /home/user/Dropbox/projects/nim/stui/nimcache/stdlib_epoll.c */
...
NIM_EXTERNC N_NOINLINE(void, stdlib_epollInit000)(void) {
	nimfr_("epoll", "epoll.nim");	popFrame();}
