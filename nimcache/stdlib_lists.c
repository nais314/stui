...
/* Command for C compiler:   gcc -c  -w -pthread -g3 -O0 -O3 -fno-strict-aliasing  -I/usr/lib/nim -o /home/user/Dropbox/projects/nim/stui/nimcache/stdlib_lists.o /home/user/Dropbox/projects/nim/stui/nimcache/stdlib_lists.c */
...
NIM_EXTERNC N_NOINLINE(void, stdlib_listsInit000)(void) {
	nimfr_("lists", "lists.nim");	popFrame();}
