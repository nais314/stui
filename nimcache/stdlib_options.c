...
/* Command for C compiler:   gcc -c  -w -pthread -g3 -O0 -O3 -fno-strict-aliasing  -I/usr/lib/nim -o /home/user/Dropbox/projects/nim/stui/nimcache/stdlib_options.o /home/user/Dropbox/projects/nim/stui/nimcache/stdlib_options.c */
...
NIM_EXTERNC N_NOINLINE(void, stdlib_optionsInit000)(void) {
	nimfr_("options", "options.nim");	popFrame();}
