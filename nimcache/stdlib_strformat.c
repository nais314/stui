...
/* Command for C compiler:   gcc -c  -w -pthread -g3 -O0 -O3 -fno-strict-aliasing  -I/usr/lib/nim -o /home/user/Dropbox/projects/nim/stui/nimcache/stdlib_strformat.o /home/user/Dropbox/projects/nim/stui/nimcache/stdlib_strformat.c */
...
NIM_EXTERNC N_NOINLINE(void, stdlib_strformatInit000)(void) {
	nimfr_("strformat", "strformat.nim");	popFrame();}
