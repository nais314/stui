...
proc floodFillScanline*(layer:UTFImageLayer, x,y:int, newColor, oldColor: Brush):void=
  ## x,y in layer coords!
  ...
  if cy >= 0:
    ...
    while cx <= cright #[ and #< layer.w and
      ...
      layer.bgColor[y][cx] == newColor.bgColor ]#
    :
          if layer.runes[cy][cx] == oldColor.rune and
