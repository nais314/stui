      ...
      if canvas.activeLayer of AsciiImageLayer:
        if calcImgPos():
          ...
          of ToolKind.Brush: # char and color
            tryIt:
              AsciiImageLayer(canvas.activeLayer).runes[RY][RX] = canvas.brush.rune[0]
              AsciiImageLayer(canvas.activeLayer).setPixelColor(
          ...
          of ToolKind.Fill:
            ...
            proc floodFillScanline(x,y:int, newColor, oldColor: Brush):void=
              ## x,y in layer coords!
              ...
              while cx < canvas.activeLayer.w and
                AsciiImageLayer(canvas.activeLayer).runes[y][cx] == oldColor.rune[0] and
                AsciiImageLayer(canvas.activeLayer).fgColor[y][cx] == oldColor.fgColor and
                AsciiImageLayer(canvas.activeLayer).bgColor[y][cx] == oldColor.bgColor:
                  AsciiImageLayer(canvas.activeLayer).runes[y][cx] = newColor.rune[0]
                  AsciiImageLayer(canvas.activeLayer).fgColor[y][cx] = newColor.fgColor
                  AsciiImageLayer(canvas.activeLayer).bgColor[y][cx] = newColor.bgColor
              ...
              if cy >= 0:
                cx = x
                # right
                while cx <= cright #[ and #< canvas.activeLayer.w and
                  AsciiImageLayer(canvas.activeLayer).runes[y][cx] == newColor.rune[0] and
                  AsciiImageLayer(canvas.activeLayer).fgColor[y][cx] == newColor.fgColor and
                  AsciiImageLayer(canvas.activeLayer).bgColor[y][cx] == newColor.bgColor ]#
                :
                      if AsciiImageLayer(canvas.activeLayer).runes[cy][cx] == oldColor.rune[0] and
                        AsciiImageLayer(canvas.activeLayer).fgColor[cy][cx] == oldColor.fgColor and
                        AsciiImageLayer(canvas.activeLayer).bgColor[cy][cx] == oldColor.bgColor:
                          floodFillScanline(cx,cy, newColor, oldColor)
                      cx.inc
                # left
                cx = x - 1
                if cx >= 0:
          ...
          of ToolKind.Ink:
            #https://lodev.org/cgtutor/floodfill.html
            proc floodInkScanline(x,y:int, newColor, oldColor: Brush):void=
              ## x,y in layer coords!
              ...
              if cy >= 0:
                cx = x
                # right
                while cx <= cright#[ < canvas.activeLayer.w and
                  AsciiImageLayer(canvas.activeLayer).fgColor[y][cx] == newColor.fgColor and
                  AsciiImageLayer(canvas.activeLayer).bgColor[y][cx] == newColor.bgColor ]#
                :
                      if AsciiImageLayer(canvas.activeLayer).fgColor[cy][cx] == oldColor.fgColor and
                        AsciiImageLayer(canvas.activeLayer).bgColor[cy][cx] == oldColor.bgColor:
                          floodInkScanline(cx,cy, newColor, oldColor)
                      cx.inc
                # left
                cx = x - 1
            ...
            if calcImgPos():
              ...
              tryIt:
                floodInkScanline(RX,RY, canvas.brush, oldColor)
